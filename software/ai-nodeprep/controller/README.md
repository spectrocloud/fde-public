...
```sh
make image-controller image-agent          # docker.io/kreeuwijk/ai-nodeprep:0.1.42-{controller,agent}
kind load docker-image docker.io/kreeuwijk/ai-nodeprep:0.1.42-controller \
                        docker.io/kreeuwijk/ai-nodeprep:0.1.42-agent
