...
```sh
make image-controller image-agent          # docker.io/kreeuwijk/ai-nodeprep:0.1.39-{controller,agent}
kind load docker-image docker.io/kreeuwijk/ai-nodeprep:0.1.39-controller \
                        docker.io/kreeuwijk/ai-nodeprep:0.1.39-agent
